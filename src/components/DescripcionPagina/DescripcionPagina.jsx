    ...
    <div className='container'>
        ...
        <p style={{
                ...
                lineHeight:'1.5rem'
                  ...
                  <br/><br/>Nuestra plataforma cuenta con una amplia variedad de títulos, desde clásicos hasta estrenos recientes. 
                  ...
                  Puedes seleccionar solo lo que realmente quieres ver y no tener que preocuparte por pagar por contenido adicional que no utilizaras.<br/><br/> Además, nuestra plataforma ofrece una excelente calidad de reproducción, para que puedas disfrutar de tu contenido favorito en alta definición.
        </p>
        <p style={{
                textAlign:'center',
                marginTop:'20px',
